import { RerankingModelV3, RerankingModelV3CallOptions, JSONSchema7, ProviderV3, LanguageModelV3, EmbeddingModelV3, ImageModelV3, ImageModelV3CallOptions, SharedV3Warning, ImageModelV3Usage, ImageModelV3ProviderMetadata } from '@ai-sdk/provider';
 ...
 */
declare const ollamaRerankingProviderOptionsSchema: z.ZodObject<{
    instruction: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
/**
 * Ollama provider options for reranking calls
 */
type OllamaRerankingProviderOptions = z.infer<typeof ollamaRerankingProviderOptionsSchema>;
/**
 ...
 */
declare function enhancedRepairText(options: {
    text: string;
    error: Error;
    schema?: JSONSchema7 | unknown;
}): Promise<string | null>;
/** Tries jsonrepair first, then enhancedRepairText for Ollama-specific edge cases. */
declare function cascadeRepairText(options: {
    text: string;
    error: Error;
    schema?: JSONSchema7 | unknown;
}): Promise<string | null>;
 ...
 */
declare const ollamaProviderOptionsSchema: z.ZodObject<{
    headers: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
}, z.core.$strip>;
/**
 * Options for configuring Ollama provider calls
 */
type OllamaProviderOptions = z.infer<typeof ollamaProviderOptionsSchema>;
/**
 * Schema for validating Ollama chat provider options
 */
declare const ollamaChatProviderOptionsSchema: z.ZodObject<{
    headers: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
 ...
 */
type OllamaChatProviderOptions = z.infer<typeof ollamaChatProviderOptionsSchema>;
/**
 * Schema for validating Ollama embedding provider options
 */
declare const ollamaEmbeddingProviderOptionsSchema: z.ZodObject<{
    headers: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
 ...
 */
type OllamaEmbeddingProviderOptions = z.infer<typeof ollamaEmbeddingProviderOptionsSchema>;
/**
...
interface OllamaImageModelConfig {
    provider: string;
    modelId: string;
    baseURL: string;
 ...
 */
declare class OllamaImageModel implements ImageModelV3 {
    private readonly config;
    readonly specificationVersion: "v3";
    readonly provider: string;
    readonly modelId: string;
    readonly maxImagesPerCall = 1;
    constructor(modelId: string, config: OllamaImageModelConfig);
...
declare function resolveToolCallingOptions(options?: ToolCallingOptions): ResolvedToolCallingOptions;
...
declare function parseToolArguments(input?: unknown): Record<string, unknown>;
...
export { type GenerateTextOptions, type ObjectGenerationOptions, type OllamaChatProviderOptions, type OllamaChatSettings, type OllamaEmbeddingProviderOptions, OllamaEmbeddingRerankingModel, type OllamaEmbeddingRerankingSettings, type OllamaEmbeddingSettings, OllamaError, type OllamaErrorData, OllamaImageModel, type OllamaProvider, type OllamaProviderOptions, type OllamaProviderSettings, OllamaRerankingModel, type OllamaRerankingProviderOptions, type OllamaRerankingSettings, type Options, type ReliableToolCallResult, type RepairTextFunction, type ResolvedToolCallingOptions, type StreamTextOptions, type ToolCallResult, type ToolCallingOptions, type ToolDefinition, cascadeRepairText, cosineSimilarity, createOllama, enhancedRepairText, generateText, ollama, ollamaChatProviderOptionsSchema, ollamaEmbeddingProviderOptionsSchema, ollamaProviderOptionsSchema, ollamaRerankingProviderOptionsSchema, parseToolArguments, resolveToolCallingOptions, streamText };
