...
import { StandardResolutionReasons as StandardResolutionReasons2 } from "@openfeature/server-sdk";
...
var OpenTelemetryHook = class {
  ...
  after(hookContext, flagValue) {
    ...
    this.metricFlags.add(1, {
      [FeatureFlagMetricAttributes.FLAG_KEY]: hookContext.flagKey,
      [FeatureFlagMetricAttributes.REASON]: (_c = flagValue.reason) != null ? _c : StandardResolutionReasons2.UNKNOWN,
      [FeatureFlagMetricAttributes.PROVIDER_NAME]: hookContext.providerMetadata.name
    });
  }
  finally(hookContext) {
...
var LoggingHook = class {
  ...
  after(hookContext, details) {
    ...
    console.log(`Evaluation details:${EOL}${JSON.stringify(details, void 0, 2)}`);
  }
  finally(hookContext) {
