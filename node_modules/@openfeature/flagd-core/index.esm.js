import { ErrorCode, StandardResolutionReasons, GeneralError, ParseError, SafeLogger, DefaultLogger } from '@openfeature/core';
import Ajv from 'ajv';
...
class FeatureFlag {
    ...
    validateStructure() {
        ...
        if (this._defaultVariant && !this._variants.has(this._defaultVariant)) {
            throw new GeneralError(`Default variant ${this._defaultVariant} missing from variants ${JSON.stringify(this._variants, undefined, 2)}`);
        }
    }
}
